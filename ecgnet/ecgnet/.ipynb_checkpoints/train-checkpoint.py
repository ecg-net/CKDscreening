...
def train(
    ...
    #                    pin_memory=True)
    #            for key in ['train', 'valid']}
    root =  "../../../data/drives/EKG/Muse2017-2019ECG_npy"
    csv =  "../../../data/drives/EKG/Muse2017-2019ECG_npy.csv"
...
true = np.load("LOS_attempt9_l2/y_valid.npy")

predicted = np.load("LOS_attempt9_l2/yh_valid.npy")

true[[predicted[:,0]>-50]]

from matplotlib import pyplot as plt

plt.scatter(true[predicted[:,0]>-50],predicted[predicted>-50])

predicted

print(true.shape,predicted.shape)

x = true[predicted[:,0]>-50]
y = predicted[predicted>-50]
...
df = pd.read_csv("LOS_attempt9_l2/log.csv",header=None,skiprows=1)

plt.plot(df[df[1]==' train'][0], df[df[1]==' train'][3])
plt.plot(df[df[1]==' train'][0], df[df[1]==' valid'][3])
